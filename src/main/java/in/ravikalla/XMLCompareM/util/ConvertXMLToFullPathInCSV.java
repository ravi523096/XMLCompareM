...
public class ConvertXMLToFullPathInCSV {
	public static List<String> getFirstLevelOfReapeatingElements(String strXML1, String strXML2) {
		...
		try {
			...
			System.out.println("72 : ConvertXMLToFullPathInCSV.getFirstLevelOfReapeatingElements(...)"
					+ " : SAXException e : " + e);
		} catch (IOException e) {
			System.out.println("75 : ConvertXMLToFullPathInCSV.getFirstLevelOfReapeatingElements(...)"
					+ " : IOException e : " + e);
		} catch (ParserConfigurationException e) {
			System.out.println("80 : ConvertXMLToFullPathInCSV.getFirstLevelOfReapeatingElements(...)"
